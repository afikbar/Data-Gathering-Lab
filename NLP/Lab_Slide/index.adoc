...
From our data exploration, we've discovered some inconsitency in the data
...
In order to evaluate our predictions, we've accessed RTPI (Real Time Passenger Information) REST API service to collect the *true* location of each bus stop in our data.
...
We were able to improve our prediction from previous tasks.
