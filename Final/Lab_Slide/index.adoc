...
* Data values are no longer atomic. uncertain data has to be summarized into atomic values. +
...
[%notitle, background-iframe="http://da2019w-1019.eastus.cloudapp.azure.com:5601/app/kibana#/dashboard/5c820d90-0ee8-11ea-920d-bd467305ad47?embed=true&_g=()"]
== Kibana
